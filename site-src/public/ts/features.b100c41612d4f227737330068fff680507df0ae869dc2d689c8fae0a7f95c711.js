(() => {
  // ns-hugo:/src/themes/hugo-tania/assets/ts/colorScheme.ts
  ...
  // ns-hugo:/src/themes/hugo-tania/assets/ts/copyButton.ts
  ...
  // ns-hugo:/src/themes/hugo-tania/assets/ts/footnotes.ts
  var removeEl = (el) => {
    if (!el)
      return;
